...
namespace LinkedList
{
    class UnorderedList
    {
        ...
        {
            string text = File.ReadAllText(@"C:\Users\Admin\source\repos\DataStructure\LinkedList\inputText.txt", Encoding.UTF8);
            ...
            File.WriteAllText(@"C:\Users\Admin\source\repos\DataStructure\LinkedList\inputText.txt", textFile);
